public class UniversityClient {
    public static void main(String[] args) {
        ...
        Student csStudent1 = new Student("Cedric Bandong", "CS001", 12000.0);
        Student csStudent2 = new Student("John Doe", "CS002", 12000.0);
        
        Teacher itProf = new Teacher("Prof. John Doe", "Intelligent Systems", 85000.0);
        Student itStudent = new Student("John Doe", "IT001", 11500.0);
